...
class DinoEnv(gym.Env):
	...
	def __init__(self, render_mode='human'):
		...
		self.observation_space = spaces.Box(low=0, high=255, shape=(600, 150,3), dtype=np.uint8)
	...
	def step(self, action):
		...
		terminated = self.done  # or use finer logic
		truncated = False       # could be True if max_steps exceeded
		#obs = self.obs.astype(np.uint8)
		info = {}
